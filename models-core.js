/**
 * dsh-plugin-quota-badges — model-list sync core (v0.5.0)
 *
 * Pure, dependency-free functions behind the model-list fix: parsing an
 * OpenAI-shaped `GET /models` reply, merging the live listing with the route's
 * installed catalog metadata, and diffing two id lists for status reporting.
 * No network and no settings access here — the server half owns both.
 *
 * @license MIT
 */
